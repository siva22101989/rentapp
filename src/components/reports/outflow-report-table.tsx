                ...
                <Table className="text-[13px]">
                    <TableHeader>
                        <TableRow className="border-b border-black">
                            ...
                            <TableHead className="text-black font-bold p-1 text-center uppercase text-[10px]">Patti No</TableHead>
                            <TableHead className="text-black font-bold p-1 text-left uppercase text-[10px]">Customer Name</TableHead>
                            <TableHead className="text-black font-bold p-1 text-center uppercase text-[10px]">Bags Out</TableHead>
                            <TableHead className="text-black font-bold p-1 text-right uppercase text-[10px]">Rent Billed</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
