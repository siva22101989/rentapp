                ...
                <Table className="text-[13px]">
                    <TableHeader>
                        <TableRow className="border-b border-black">
                            ...
                            <TableHead className="text-black font-bold p-1 text-center uppercase text-[10px]">Commodity</TableHead>
                            <TableHead className="text-black font-bold p-1 text-right uppercase text-[10px]">Bags</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {records.map((record) => (
