...
const PaymentSchema = z.object({
  ...
  paymentType: z.enum(['interest', 'principal'], { required_error: 'Payment type is required.' }),
});
                      ...
                      <FormControl>
                        ...
                        >
                          <FormItem className="flex items-center space-x-2 space-y-0">
                            ...
                            <FormLabel className="font-normal">Interest Received</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-2 space-y-0">
                            <FormControl><RadioGroupItem value="principal" /></FormControl>
                            <FormLabel className="font-normal">Principal Received</FormLabel>
                          </FormItem>
                        </RadioGroup>
                      </FormControl>
                      <FormMessage />
